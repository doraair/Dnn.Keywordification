        ...
        _onLoadData: function (src, arg) {
            ...
            $('#' + this.get_ns() + 'jqgrid').jqGrid({
                ...
                colModel: [
                    ...
                    { name: 'Title', index: 'Title', width: 175, editable: true, edittype: 'textarea', editoptions: { maxlength: '200', rows: 3 } },
                    { name: 'KeyWords', index: 'KeyWords', width: 100, editable: true, edittype: 'textarea', editoptions: { rows: 3 } },
                    { name: 'Description', index: 'Description', width: 400, editable: true, edittype: 'textarea', editoptions: { maxlength: '500', rows: 3 } }
                ],
                jsonReader: {
                    root: "rows",
                    id: "TabID",
                ...
                onSelectRow: function (ids) {
                    var pd = $('#' + this.id).jqGrid('getGridParam');
                    var r = null;
            ...
            var tempthis = this;
            $('#' + this.get_ns() + 'jqgrid').jqGrid('setGridParam', { baseclass: tempthis }).trigger("reloadGrid");
